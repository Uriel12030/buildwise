...
-- Projects (using valid hex UUIDs - 'a' instead of 'p')
insert into public.projects (id, name, project_code, client_id, status, location, description, start_date, end_date) values
  ('a1000000-0000-0000-0000-000000000001', 'Tower 42 Residential Complex', 'PRJ-001', 'c1000000-0000-0000-0000-000000000001', 'active', 'Herzliya Marina', 'High-rise residential tower, 42 floors, luxury apartments', '2024-06-01', '2026-12-31'),
  ('a1000000-0000-0000-0000-000000000002', 'Green Valley Housing', 'PRJ-002', 'c1000000-0000-0000-0000-000000000002', 'active', 'Modiin', '120-unit residential development with parks', '2024-09-01', '2026-06-30'),
  ('a1000000-0000-0000-0000-000000000003', 'City Park Renovation', 'PRJ-003', 'c1000000-0000-0000-0000-000000000003', 'planning', 'Tel Aviv, Yarkon Park', 'Infrastructure renovation of Yarkon Park facilities', '2025-04-01', '2025-12-31'),
  ('a1000000-0000-0000-0000-000000000004', 'Industrial Warehouse B7', 'PRJ-004', 'c1000000-0000-0000-0000-000000000004', 'active', 'Haifa Bay', 'New 5000sqm warehouse construction', '2024-11-01', '2025-08-30'),
  ('a1000000-0000-0000-0000-000000000005', 'Solar Farm Phase 2', 'PRJ-005', 'c1000000-0000-0000-0000-000000000005', 'on_hold', 'Arad', 'Expansion of solar panel farm, 50MW additional capacity', '2025-01-15', null),
  ('a1000000-0000-0000-0000-000000000006', 'Office Tower Renovation', 'PRJ-006', 'c1000000-0000-0000-0000-000000000001', 'completed', 'Ramat Gan Diamond Exchange', 'Complete renovation of 15-story office building', '2023-06-01', '2024-12-31');

-- Project Employees
insert into public.project_employees (project_id, employee_id, assigned_from) values
  ('a1000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000001', '2024-06-15'),
  ('a1000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000002', '2024-07-01'),
  ('a1000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000003', '2024-08-01'),
  ('a1000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000004', '2024-06-01'),
  ('a1000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000007', '2024-09-01'),
  ('a1000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000005', '2024-09-15'),
  ('a1000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000006', '2024-10-01'),
  ('a1000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000007', '2024-10-01'),
  ('a1000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000001', '2024-11-15'),
  ('a1000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000003', '2024-11-15'),
  ('a1000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000010', '2024-12-01');

-- Daily Logs
insert into public.daily_logs (id, project_id, log_date, weather, work_summary, notes, issues, status) values
  ('d1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', current_date, 'Sunny, 28C', 'Completed floor 18 concrete pour. Rebar installation on floor 19 started.', 'Concrete truck arrived 30 minutes late.', 'Minor delay due to concrete delivery.', 'submitted'),
  ('d1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000001', current_date - interval '1 day', 'Partly cloudy', 'Floor 17 finishing work. Electrical conduit installation floors 15-16.', null, null, 'approved'),
  ('d1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000002', current_date, 'Sunny', 'Foundation work for buildings C and D. Drainage system installation.', 'Soil test results received - all good.', null, 'draft'),
  ('d1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000004', current_date - interval '1 day', 'Cloudy, 22C', 'Steel frame erection for section B. Roofing material delivered.', null, 'Crane needed servicing, 2hr downtime.', 'submitted'),
  ('d1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000002', current_date - interval '2 days', 'Rain', 'Limited outdoor work due to rain. Indoor electrical work on building A.', 'Rain stopped by 2PM, resumed grading.', 'Weather delay - 4 hours lost.', 'approved'),
  ('d1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000001', current_date - interval '3 days', 'Sunny', 'Floor 16 concrete pour completed. Safety inspection passed.', 'Inspector approved all safety measures.', null, 'approved'),
  ('d1000000-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000004', current_date - interval '2 days', 'Windy', 'Foundation inspection. Utility connections started.', null, 'High winds - suspended crane operations after 3PM.', 'approved');
